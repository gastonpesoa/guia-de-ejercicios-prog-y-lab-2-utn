...
namespace FormEstante
{
    public partial class FormEstante : Form
    {
        ...
        {
            return prodUno.Marca.ToString().CompareTo(prodDos.Marca.ToString());
        }
        ...
        private void btnEjecutar_Click(object sender, EventArgs e)
        {
            ...
            rtxtSalida.Text += String.Format("Valor total Estante1: {0}\n", est1.ValorEstanteTotal);
        ...
        private void CargarEstante(out Estante est1, out Estante est2)
        {
            ...
            if (!(est1 + h1))
            {
                MessageBox.Show("No se pudo agregar el producto al estante!!!","Error",MessageBoxButtons.OK);
            }
            if (!(est1 + g1))
            {
                MessageBox.Show("No se pudo agregar el producto al estante!!!", "Error", MessageBoxButtons.OK);
